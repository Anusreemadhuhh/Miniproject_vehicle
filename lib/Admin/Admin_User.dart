                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        Row(
                          children: [
                            Container(height:30,width:30,child: InkWell(
                                onTap: () {
                          ...
                          children: [
                            Padding(
                              ...
                              child: Container(
                                width: 150,
                                height: 150,
                                decoration: BoxDecoration(color: Colors.grey,borderRadius: BorderRadius.circular(100),image: DecorationImage(image: AssetImage('assets/girl.jpeg'),)),
                              ),
                            ),
                            Center(
                                child: Text(
