    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        builder: (context, snapshot) {
          ...
          final mech_ls = snapshot.data!.docs.where(
                  (doc){
                String Search_Task=doc["Username"].toString().toLowerCase();
                    ...
                    Navigator.push(context, MaterialPageRoute(
                      builder: (context) {
                        return User_mechanic_detail(
                            ...
                            phn_no: Mech_list["Phonenumber"],
                            experience: Mech_list["WorkExperience"],
                            ...
                            Column(
                              ...
                              children: [
                                Align(
                                  ...
                                  child: Text(
                                    "${Mech_list["WorkExperience"] ?? ""} Of Experience",
                                    style: TextStyle(
                                        color: Colors.black,
...
class _Mechanic_requestState extends State<Mechanic_request> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: StreamBuilder(
          stream: FirebaseFirestore.instance.collection("User_request").where("User_id",isEqualTo: id).snapshots(),
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              return Center(child: CircularProgressIndicator());
            }
            ...
            final Mech_detail = snapshot.data!.docs.where(
                    (doc){
